...
import type { ProjectTimelineItemRow, TimelineStatus } from "@/lib/database.types";
import { WmlProjectDetail, type WmlProject } from "./wml/wml-project-detail";
...
export default async function ProjectDetailPage({
  ...
  const project = projectData as unknown as WmlProject;
  ...
  return (
    <div className="space-y-6">
      ...
      {isWml ? (
        <WmlProjectDetail project={project} />
      ) : (
        <GenericProjectDetail projectId={id} project={project} />
      )}
    </div>
  );
}

/** The original generic project detail layout, used for non-WML project types. */
async function GenericProjectDetail({
  projectId,
  project,
}: {
  projectId: string;
    ...
    <div className="grid gap-6 lg:grid-cols-3">
      <div className="space-y-6 lg:col-span-2">
          ...
          <CardContent className="space-y-5">
            ...
            <div className="grid gap-x-6 gap-y-3 text-sm sm:grid-cols-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="font-medium">{fmtDate(project.target_date)}</span>
              </div>
            </div>
            <Separator />
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Generated from the {PROJECT_TYPE_LABELS[project.project_type]} template.
              Stages marked with an eye are visible to the client.
            </CardDescription>
          </CardHeader>
          <CardContent>
            {items.length === 0 ? (
      ...
      <div className="space-y-6">
        ...
        {project.description && (
          <Card>
            <CardHeader>
              <CardTitle className="text-base">Internal description</CardTitle>
